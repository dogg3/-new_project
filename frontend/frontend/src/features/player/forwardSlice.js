...
const forwardSlicer = createSlice({
    name: 'forward',
    initialState:{
        player: null,
        loading_error: false
...
} = forwardSlicer.actions;


///PLAYER INFO
export const fetch_player_info = (playerId,position) =>  async (dispatch) => {
    const API_PLAYER_INFO = 'http://35.246.111.237/api/forwards/playerinfo/' + playerId;
...
export const fetch_duels_info = (playerId) => async (dispatch) => {
    const API_DUELS_INFO = 'http://35.246.111.237/api/forwards/duels/info/' + playerId;
...
export const fetch_duels_analytics = (playerId) => async (dispatch) => {
    const API_DUELS_ANALYTICS = 'http://35.246.111.237/api/forwards/duels/analytics/' + playerId;
...
export const fetch_passes_info = (playerId) => async (dispatch) => {
    const API_PASSES_INFO = 'http://35.246.111.237/api/forwards/passes/info/' + playerId;
...
export const fetch_passes_analytics = (playerId) => async (dispatch) => {
    const API_PASSES_ANALYTICS = 'http://35.246.111.237/api/forwards/passes/analytics/' + playerId;
...
export const fetch_shots_info = (playerId) => async (dispatch) => {
    const API_SHOTS_INFO = 'http://35.246.111.237/api/forwards/shots/info/' + playerId;
...
export const fetch_shots_analytics = (playerId) => async (dispatch) => {
    const API_SHOTS_ANALYTICS = 'http://35.246.111.237/api/forwards/shots/analytics/' + playerId;
...
export const fetch_matches = (playerId) => async (dispatch) => {
    const API_MATCHES = 'http://35.246.111.237/api/forwards/matches/' + playerId;
...
export const fetch_rankings = (playerId) => async (dispatch) => {
    const API_RANKINGS = 'http://35.246.111.237/api/forwards/rankings/' + playerId;
...
export const fetch_duels_stats = () => (dispatch) => {
    const API_DUELS_STATS = 'http://35.246.111.237/api/forwards/duels/analytics/stats';
...
export const fetch_passes_stats = () => (dispatch) => {
    const API_PASSES_STATS = 'http://35.246.111.237/api/forwards/passes/analytics/stats';
...
export const fetch_shots_stats = () => (dispatch) => {
    const API_SHOTS_STATS = 'http://35.246.111.237/api/forwards/shots/analytics/stats';
...
export const fetch_rankings_stats = () => (dispatch) => {
    const API_RANKINGS_STATS = 'http://35.246.111.237/api/forwards/rankings/stats';
...
export const fetch_matches_stats = (playerId) => (dispatch) => {
    const API_MATCHES_STATS = 'http://35.246.111.237/api/forwards/matches/stats';
...
export default forwardSlicer.reducer