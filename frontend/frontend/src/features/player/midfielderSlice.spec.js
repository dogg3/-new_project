import {fetch_player_info,  loading_player_info, loading_player_info_success, loading_player_info_failure, set_player_id} from './midfielderSlice'
import {fetch_duels_info, loading_duels_info, loading_duels_info_success, loading_duels_info_failure,fetch_duels_analytics, loading_duels_analytics, loading_duels_analytics_success, loading_duels_analytics_failure} from "./midfielderSlice";
import {fetch_passes_info, loading_passes_info, loading_passes_info_success, loading_passes_info_failure,fetch_passes_analytics, loading_passes_analytics, loading_passes_analytics_success, loading_passes_analytics_failure} from "./midfielderSlice";
import {fetch_shots_info, loading_shots_info, loading_shots_info_success, loading_shots_info_failure,fetch_shots_analytics, loading_shots_analytics, loading_shots_analytics_success, loading_shots_analytics_failure} from "./midfielderSlice";
import {fetch_matches, loading_matches, loading_matches_success, loading_matches_failure} from "./midfielderSlice";
import {fetch_rankings, loading_rankings, loading_rankings_success, loading_rankings_failure} from "./midfielderSlice";


import configureMockStore from 'redux-mock-store'
import thunk from 'redux-thunk'
import * as actions from "./midfielderSlice";
...
describe("Testing the player slice reducers" , () =>{
    ...
    describe('Testing playerinfo', () =>{
        ...
        it('Should handle fetch success of player info for midfielders',()=>{
        ...
        it('Should handle fetch failure of player info for midfielders',()=>{

            const store = mockStore();
            mock.onGet('http://35.246.111.237/api/midfielders/playerinfo/' + playerId).reply(404);
            return store.dispatch(fetch_player_info(playerId)).then(() => {
    ...
    describe('Testing player duels', () =>{
        ...
        describe('Duels info',()=>{
            ...
            it('Should handle fetch success of duel info',()=>{
                const store = mockStore();
                mock.onGet('http://35.246.111.237/api/midfielders/duels/info/' + playerId).reply(200, {
            ...
            it('Should handle fetch failure of player info',()=>{
                const store = mockStore();
                mock.onGet('http://35.246.111.237/api/midfielders/duels/info/' + playerId).reply(404);
                return store.dispatch(fetch_duels_info(playerId)).then(() => {
        ...
        describe('Duels analytics',()=>{
            ...
            it('Should handle fetch success of duel analytics',()=>{
                const store = mockStore();
                mock.onGet('http://35.246.111.237/api/midfielders/duels/analytics/' + playerId).reply(200, {
                    36 : {name: 'douglas landvik'}
                });
                const resp = {36 : {name: 'douglas landvik'}};
            ...
            it('Should handle fetch failure of duel analytics',()=>{
                const store = mockStore();
                mock.onGet('http://35.246.111.237/api/midfielders/duels/analytics/' + playerId).reply(400);
    ...
    describe('Testing player passes', ()=>{
        ...
        describe('Passes info',()=>{
            ...
            it("Should handle fetch success of passes info", ()=>{
                const store = mockStore();
                mock.onGet('http://35.246.111.237/api/midfielders/passes/info/' + playerId).reply(200, {
                    36 : {name: 'douglas landvik'}
                });
                const resp = {36 : {name: 'douglas landvik'}};
            ...
            it("Should handle fetch failure of passes info", ()=>{
                const store = mockStore();
                mock.onGet('http://35.246.111.237/api/midfielders/passes/info/' + playerId).reply(404);
                return store.dispatch(fetch_passes_info(playerId)).then(() => {
        ...
        describe('Passes analytics',()=>{
            ...
            it('Should handle fetch success of duel analytics',()=>{
                const store = mockStore();
                mock.onGet('http://35.246.111.237/api/midfielders/passes/analytics/' + playerId).reply(200, {
                    36 : {name: 'douglas landvik'}
                });
                const resp = {36 : {name: 'douglas landvik'}};
            ...
            it('Should handle fetch failure of duel analytics',()=>{
                const store = mockStore();
                mock.onGet('http://35.246.111.237/api/midfielders/passes/analytics/' + playerId).reply(400);
    ...
    describe('Testing player shots', ()=>{
        ...
        describe('Shots info',()=>{
            ...
            it("Should handle fetch success of shots info", ()=>{
                const store = mockStore();
                mock.onGet('http://35.246.111.237/api/midfielders/shots/info/' + playerId).reply(200, {
                    36 : {name: 'douglas landvik'}
                });
                const resp = {36 : {name: 'douglas landvik'}};
            ...
            it("Should handle fetch failure of shots info", ()=>{
                const store = mockStore();
                mock.onGet('http://35.246.111.237/api/midfielders/shots/info/' + playerId).reply(404);
                return store.dispatch(fetch_shots_info(playerId)).then(() => {
        ...
        describe('Shots analytics',()=>{
            ...
            it('Should handle fetch success of duel analytics',()=>{
                const store = mockStore();
                mock.onGet('http://35.246.111.237/api/midfielders/shots/analytics/' + playerId).reply(200, {
                    36 : {name: 'douglas landvik'}
                });
                const resp = {36 : {name: 'douglas landvik'}};
            ...
            it('Should handle fetch failure of duel analytics',()=>{
                const store = mockStore();
                mock.onGet('http://35.246.111.237/api/midfielders/shots/analytics/' + playerId).reply(400);
    ...
    describe('Testing player matches',()=>{
        it('Should handle fetch success of matches',()=>{
            const store = mockStore();
            mock.onGet('http://35.246.111.237/api/midfielders/matches/' + playerId).reply(200, {
                36 : {name: 'douglas landvik'}
            });
            const resp = {36 : {name: 'douglas landvik'}};
        ...
        it('Should handle fetch success of matches',()=>{
            const store = mockStore();
            mock.onGet('http://35.246.111.237/api/midfielders/matches/' + playerId).reply(400);
            const resp = {36 : {name: 'douglas landvik'}};
            return store.dispatch(fetch_matches(playerId)).then(() => {
                ////console.log()(store.getActions())
                expect(store.getActions()[0].type).toEqual(loading_matches.type);
    ...
    describe('Testing player rankings',()=>{
        it('Should handle fetch success of rankings',()=>{
            const store = mockStore();
            mock.onGet('http://35.246.111.237/api/midfielders/rankings/' + playerId).reply(200, {
                36 : {name: 'douglas landvik'}
            });
            const resp = {36 : {name: 'douglas landvik'}};
        ...
        it('Should handle fetch success of rankings',()=>{
            const store = mockStore();
            mock.onGet('http://35.246.111.237/api/midfielders/rankings/' + playerId).reply(400);
            const resp = {36 : {name: 'douglas landvik'}};
            return store.dispatch(fetch_rankings(playerId)).then(() => {
                ////console.log()(store.getActions())
                expect(store.getActions()[0].type).toEqual(loading_rankings.type);
    ...
    describe('Testing stats',()=>{
        ...
        describe('Testing matches stats',()=>{
            it('Should handle matches stats succesfully', () =>{
                const store = mockStore();
                mock.onGet('http://35.246.111.237/api/midfielders/matches/analytics/stats').reply(200, {
                    36 : {name: 'douglas landvik'}
                });
                const resp = {36 : {name: 'douglas landvik'}};
            ...
            it('Should handle matches stats unsucessfully', () =>{
                const store = mockStore();
                mock.onGet('http://35.246.111.237/api/midfielders/matches/analytics/stats' + playerId).reply(400);
                const resp = {36 : {name: 'douglas landvik'}};
                return store.dispatch(actions.fetch_matches_stats()).then(() => {
                }).catch(err=>{
        ...
        describe('Testing rankings stats',()=>{
            it('Should handle rankings stats succesfully', () =>{
                const store = mockStore();
                mock.onGet('http://35.246.111.237/api/midfielders/rankings/analytics/stats').reply(200, {
                    36 : {name: 'douglas landvik'}
                });
                const resp = {36 : {name: 'douglas landvik'}};
            ...
            it('Should handle rankings stats unsucessfully', () =>{
                const store = mockStore();
                mock.onGet('http://35.246.111.237/api/midfielders/rankings/analytics/stats' + playerId).reply(400);
                const resp = {36 : {name: 'douglas landvik'}};
                return store.dispatch(actions.fetch_rankings_stats()).then(() => {
                }).catch(err=>{
