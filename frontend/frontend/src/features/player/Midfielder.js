...
const shotsHelp = () => (
    ( <div>
        ...
        <p>These metrics are only included for midfielders and forwards</p>
...
const mapStateToProps = state => {
    ...
    //playerinfo
    const {player_info,player_info_loading} = state.midfielder;
    //duels info
    const {duels_info,duels_analytics} = state.midfielder;
    //passes
    const {passes_info,passes_analytics} = state.midfielder;
    //Shots
    const {shots_info,shots_analytics} = state.midfielder;


    const {matches, rankings} = state.midfielder;

    const {duels_stats,passes_stats,matches_stats,rankings_stats, shots_stats} = state.midfielder;
