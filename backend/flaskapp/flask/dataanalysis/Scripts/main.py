...
defenders.to_pickle('../preprocessed/final/defenders.pkl')
...
midfielders.to_pickle('../preprocessed/final/midfielders.pkl')
forwards.to_pickle('../preprocessed/final/forwards.pkl')
